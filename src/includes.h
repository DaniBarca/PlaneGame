...
#define _CRT_SECURE_NO_DEPRECATE //Evita els errors deprecated
...
#define IMPORT_GLEXT(FUNCNAME) FUNCNAME = (FUNCNAME ## _func) getGLProcAddress(#FUNCNAME); if (FUNCNAME == NULL) { std::cout << "ERROR: This Graphics card doesnt support " << #FUNCNAME << std::endl; }
